    ...
    <Box className="py-14 bg-white">
      ...
      >
        ...
        <Typography variant="h6" className="my-1" style={{ color: "#575757" }}>
          Early adopter rewards. Discounted presale for early members (SOLD OUT)
          <br />
      ...
      >
        ...
        <Typography variant="h6" className="my-1" style={{ color: "#575757" }}>
          33 Sol Donation to Madagascar / Lemur conservation charity voted on by
          Lemur owners.
        </Typography>
      </Box>
      <Box
      ...
      >
        ...
        <Typography variant="h6" className="my-1" style={{ color: "#575757" }}>
          7 Lucky Lemurs will each win 7% of every weeks secondary sales
          royalties. There will be one winner for every rarity background with
          odds to win determined by the number of that background in
          circulation. The more rare the background the better the odds of
          winning. The remainder of royalty funds will be used for periodic
          floor sweeps to reduce token supply.
        </Typography>
      </Box>
    </Box>
  );
